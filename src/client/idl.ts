export type NftCandyMachine = {
    ...
    errors: [
      ...
      {
        code: 6015;
        name: 'UniverseAlreadyEvolving';
        msg: 'This Universe is currently evolving!';
      },
      {
        code: 6016;
        name: 'NoEvolutionPoints';
        msg: "This Universe doesn't have evolution points!";
      },
    ];
  };
